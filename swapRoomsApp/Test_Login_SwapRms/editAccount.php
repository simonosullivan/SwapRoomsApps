...
if(isset($postdata) && !empty($postdata)){ 
    ...
    addrRm = '$addrRm',
    county = '$county'
    WHERE account.rmId = '$rmId'";

    $sqlAmenities = "UPDATE amenities 
    SET 
    wifi = '$wifi',
    cableTV = '$cableTv',
    iron = '$iron',
    ...
    heating = '$heating',
    laptopWorkspace = '$laptopWorkspace',
    hotWater = '$hotWater',
    ...
    dishesSilverware = '$dishesSilverware',
    smartLock = '$smartLock',
    shampoo = '$shampoo',
    hairDryer = ' $hairDryer',
    hangers = '$hangers',
    ...
    if($result == 3){
        echo json_encode(array("message" => "Successful edit of account"));
    }
    else{
        echo json_encode(array("message" => "Failed edit of account"));
    }
